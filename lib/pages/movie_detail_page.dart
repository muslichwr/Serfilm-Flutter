...
//     try {
//       final result = await _tmdbService.getMovieDetails(widget.movieId);
//       if (result.containsKey('error')) {
//         throw Exception(result['error']);
//       }

//       // Konversi result menjadi MovieDetails
//       // Ini implementasi sederhana, sesuaikan dengan model MovieDetails yang ada
//       final details = MovieDetails.fromJson(result);
...
//     } catch (e) {
//       setState(() {
//         _error = 'Failed to load movie details: ${e.toString()}';
//         _isLoading = false;
//       });
//     }
//   }
...
//             imageBaseUrl:
//                 (path, {size = 'w185'}) =>
//                     _tmdbService.getPosterUrl(path ?? '', size: size),
//           ),
//         ],
//       ),
//     );
